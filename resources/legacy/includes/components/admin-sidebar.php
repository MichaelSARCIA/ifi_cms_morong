<aside id="mainSidebar"
    ...
    <div class="h-24 flex items-center px-8 border-b border-gray-100 dark:border-gray-800">
        <div class="flex items-center gap-4 text-primary relative group">
            <div
                class="absolute -inset-2 bg-blue-50 dark:bg-blue-900/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300">
            </div>
            ...
            <div class="relative z-10">
                ...
                <span class="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-0.5 block">CMS
                    Admin</span>
            </div>
        </div>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto py-8 px-4 space-y-2 custom-scrollbar">
        ...
        <a href="members-directory.php"
            class="flex items-center gap-4 px-5 py-3.5 <?php echo $current_page == 'members-directory.php' ? 'bg-gradient-to-r from-primary to-blue-600 text-white shadow-lg shadow-blue-500/30' : 'text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-primary dark:text-gray-400 dark:hover:text-white'; ?> rounded-xl font-medium transition-all group duration-200">
            <i
                class="fas fa-users w-5 text-center text-lg <?php echo $current_page == 'members-directory.php' ? 'text-white' : 'group-hover:scale-110 transition-transform'; ?>"></i>
            <span class="tracking-wide text-sm">Parish Registry</span>
        </a>

        <a href="scheduling.php"
            class="flex items-center gap-4 px-5 py-3.5 <?php echo $current_page == 'scheduling.php' ? 'bg-gradient-to-r from-primary to-blue-600 text-white shadow-lg shadow-blue-500/30' : 'text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-primary dark:text-gray-400 dark:hover:text-white'; ?> rounded-xl font-medium transition-all group duration-200">
            <i
                class="fas fa-calendar-alt w-5 text-center text-lg <?php echo $current_page == 'scheduling.php' ? 'text-white' : 'group-hover:scale-110 transition-transform'; ?>"></i>
            <span class="tracking-wide text-sm">Scheduling</span>
        </a>

        <a href="sacraments.php"
            class="flex items-center gap-4 px-5 py-3.5 <?php echo $current_page == 'sacraments.php' ? 'bg-gradient-to-r from-primary to-blue-600 text-white shadow-lg shadow-blue-500/30' : 'text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-primary dark:text-gray-400 dark:hover:text-white'; ?> rounded-xl font-medium transition-all group duration-200">
            <i
                class="fas fa-bible w-5 text-center text-lg <?php echo $current_page == 'sacraments.php' ? 'text-white' : 'group-hover:scale-110 transition-transform'; ?>"></i>
            <span class="tracking-wide text-sm">Sacraments</span>
        </a>

        <a href="reports.php"
            class="flex items-center gap-4 px-5 py-3.5 <?php echo $current_page == 'reports.php' ? 'bg-gradient-to-r from-primary to-blue-600 text-white shadow-lg shadow-blue-500/30' : 'text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-primary dark:text-gray-400 dark:hover:text-white'; ?> rounded-xl font-medium transition-all group duration-200">
            <i
                class="fas fa-chart-pie w-5 text-center text-lg <?php echo $current_page == 'reports.php' ? 'text-white' : 'group-hover:scale-110 transition-transform'; ?>"></i>
            <span class="tracking-wide text-sm">Reports</span>
        </a>
        ...
        <a href="users.php"
            class="flex items-center gap-4 px-5 py-3.5 <?php echo $current_page == 'users.php' ? 'bg-gradient-to-r from-primary to-blue-600 text-white shadow-lg shadow-blue-500/30' : 'text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800 hover:text-primary dark:text-gray-400 dark:hover:text-white'; ?> rounded-xl font-medium transition-all group duration-200">
            <i
                class="fas fa-users-cog w-5 text-center text-lg <?php echo $current_page == 'users.php' ? 'text-white' : 'group-hover:scale-110 transition-transform'; ?>"></i>
    ...
    <div class="p-6 border-t border-gray-100 dark:border-gray-800 space-y-3 bg-gray-50/50 dark:bg-gray-900/50">
        <!-- Appearance Toggle Button (Type Button to prevent form submit issues) -->
        ...
        <button onclick="confirmLogout()"
            class="w-full flex items-center gap-3 px-4 py-3 text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-colors text-sm font-bold border border-transparent hover:border-red-100 dark:hover:border-red-900/30">
