        ...
        <div
            ...
            <div class="w-full max-w-md mx-auto">
                <div class="mb-12">
                    ...
                    <h2 class="text-4xl font-bold text-gray-900 dark:text-white mb-3 tracking-tight">Forgot Password?
                    </h2>
                    <p class="text-base text-gray-500 dark:text-gray-400 leading-relaxed">Enter your email address and
