...
@section('title', 'New Pending Service Request')

@section('content')
    <h1 style="color: #1a202c; font-size: 24px; font-weight: 800; margin: 0 0 16px 0; letter-spacing: -0.5px; line-height: 1.2;">
        New Pending Service Request
    </h1>

    <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin: 0 0 24px 0;">
        Dear Priest,<br><br>
        A new pending service application has been submitted and is awaiting your initial review.
    </p>
    ...
    <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin: 0 0 32px 0;">
        Please log in to the {{ $settings['system_short_name'] ?? 'IFI CMS' }} to review the application and manage the request.
    </p>
